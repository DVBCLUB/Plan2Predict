    ...
    <div className="space-y-5 text-slate-100 select-text">
      <section className="bg-gradient-to-r from-sky-950/20 via-[#060a12] to-emerald-950/20 border border-slate-800 rounded-2xl p-5">
        <div className="flex items-start gap-4">
          ...
          <div>
            <h2 className="text-sm font-black text-white uppercase tracking-widest">Release Notes Generator</h2>
            <p className="text-xs text-slate-400 mt-1 font-semibold leading-relaxed">Tạo ghi chú release ngắn gọn cho mỗi lần AI sửa code, giúp kiểm soát thay đổi, test, rollback và triển khai Cloud Run.</p>
          </div>
        </div>
      </section>
